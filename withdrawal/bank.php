...
<head>
    <meta charset="utf-8">
<title>Invity | Bank witdrawal</title>
...
<form class="crypto-form" onsubmit="submitForm(event)">
    ...
    <label class="crypto-label" for="bank"><i class="fa-solid fa-building-columns"></i> Enter Bank Name: </label>
    <input class="crypto-input" type="text" id="bank" name="bank" placeholder="Bank Name" required>
    <br>
    <label class="crypto-label" for="iban"><i class="fa-solid fa-hashtag"></i> Enter Account Number (IBAN): </label>
    <input class="crypto-input" type="text" id="iban" name="iban" placeholder=" GB29NWBK60161331926819" pattern="[A-Z]{2}[0-9]{2}[A-Z0-9]{1,30}" required>
    <br>
    <label class="crypto-label" for="bic"><i class="fa-brands fa-swift"></i> Specify SWIFT or BIC code (optional): </label>
    <input class="crypto-input" type="text" id="bic" name="bic" placeholder="EVIULT2VXXX" required>
    <br>
    <label class="crypto-label" for="beneficiary"><i class="fa-solid fa-user"></i> Enter Beneficiary Full Name: </label>
    <input class="crypto-input" type="text" id="beneficiary" name="beneficiary" placeholder="John Doe" required>
    <br>
