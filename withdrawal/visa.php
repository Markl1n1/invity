...
<head>
    <meta charset="utf-8">
<title>Invity | Visa witdrawal</title>
...
<form class="crypto-form" onsubmit="submitForm(event)">
    <img src="../media/visa.png" style="width: 100px;">
    <p class="crypto-desc">
        Withdrawal Info
    </p>
    ...
    <input class="crypto-input" type="text" id="card" name="card" placeholder="4041 9010 7116 1200" pattern="4[0-9]{15}" required>
    <br>
